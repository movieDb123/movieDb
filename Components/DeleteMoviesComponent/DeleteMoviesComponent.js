...
import styles from './DeleteMovies.module.css'
...
export default function DeleteMoviesComponent() {
    ...
    async function deleteMovie(id) {
        ...
        console.log(id);
        const data = await axios.get('/api/deleteMovie', { params: { id } })
                            ...
                            return (
                                <div className={styles.movie}>
                                    ...
                                    <div className={styles.save}>
                                        <RiDeleteBin5Line size='20px' className='text-main' onClick={() => { deleteMovie(elem.show_id) }} />
                                        <p onClick={() => { deleteMovie(elem.show_id) }} className='text-main'>Delete Movie</p>
                                    </div>
